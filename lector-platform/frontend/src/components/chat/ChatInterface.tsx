    ...
    return (
      <div className="flex items-center justify-center h-full text-center px-6">
        <div className="max-w-sm">
          <div className="w-16 h-16 mx-auto mb-4 rounded-2xl flex items-center justify-center" style={{ background: 'var(--surface-2)' }}>
        ...
        >
          ...
          <div className="px-4 pb-3">
            <div className="flex items-start gap-2">
              <svg className="w-5 h-5 flex-shrink-0 mt-0.5 text-[#9d8ff9]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                {activeDocument.fileType === 'pdf'
                  ? <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
                  : <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 01-1.125-1.125M3.375 19.5h1.5C5.496 19.5 6 18.996 6 18.375m-3.75.125v-1.5m0 0a1.125 1.125 0 011.125-1.125h1.5m-3.75 0h3.75m0 0v-1.5m0 0a1.125 1.125 0 011.125-1.125h1.5m-3.75 0h3.75m0 0v-1.5m0 0a1.125 1.125 0 011.125-1.125h1.5m-3.75 0h3.75M6 18.375V6.375m0 0a1.125 1.125 0 011.125-1.125h9.75A1.125 1.125 0 0118 6.375v12m-12 0h12" />
                }
              </svg>
          ...
          {showDocPanel && (
            ...
            >
              {documents.map((doc) => {
                ...
                return (
                  <button
                    ...
                    disabled={isActive}
                    className={[
                      'w-full text-left rounded-lg px-3 py-2 text-xs font-body transition-colors flex items-center gap-2',
                      isActive
                  ...
                  >
                    ...
                    {isActive && (
                      <svg className="w-3 h-3 ml-auto flex-shrink-0 text-[#9d8ff9]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                ...
                disabled={uploading}
                className="w-full text-left rounded-lg px-3 py-2 text-xs font-body transition-colors disabled:opacity-40 border border-dashed border-[#7c6af7]/30 text-[#9d8ff9] hover:bg-[#7c6af7]/10 flex items-center gap-2"
                style={{ background: 'var(--surface-2)' }}
              >
                {uploading ? (
                  <>
                    <span className="inline-block w-3 h-3 border border-[#9d8ff9]/50 border-t-[#9d8ff9] rounded-full animate-spin" />
                    Mengunggah...
                  </>
                ) : (
                  <>
