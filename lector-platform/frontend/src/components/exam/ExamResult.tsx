...
export default function ExamResult({ score, correctCount, totalCount, questions, answers, onRetry, newTitles }: ExamResultProps) {
      ...
      <div className="rounded-2xl p-6 text-center space-y-3"
        ...
        {newTitles && newTitles.length > 0 && (
          <div className="flex flex-wrap gap-2 justify-center">
            {newTitles.map((t) => (
              <span key={t} className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold font-body"
                style={{ background: 'rgba(124,106,247,0.15)', color: '#9d8ff9', border: '1px solid rgba(124,106,247,0.4)' }}>
